...
def main():        
        ...
        print("number of uncertain significance: " + str(num_of_uncertain))
        output += "number of uncertain significance: " + str(num_of_uncertain) + '\n'
        if num_of_clinvar != 0:
                print("There are"+ str(num_of_uncertain / num_of_clinvar) + "rsid with clinical significance that with uncertain significance status")
                output += "There are"+ str(num_of_uncertain / num_of_clinvar) + "rsid with clinical significance that with uncertain significance status \n"
        print("we done")
